...
public class AutonVomit extends CommandGroup {// Vomit autonomously
	...
	public AutonVomit() {
		...
		addParallel(new ChassisMoveDistance(RobotMap.Component.chassis, AutonVomit.distance1, null, new Kill(this), RobotMap.Component.leftWheelEncoder));// in inches
		addSequential(new ChassisTurn(RobotMap.Component.chassis, 135, RobotMap.Component.navX, new Kill(this), null));// in degrees
		addSequential(new ChassisMoveDistance(RobotMap.Component.chassis, AutonVomit.distance2, null, new Kill(this), RobotMap.Component.leftWheelEncoder)); // in inches
