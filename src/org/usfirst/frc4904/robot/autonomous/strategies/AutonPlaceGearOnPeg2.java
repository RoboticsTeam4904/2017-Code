...
public class AutonPlaceGearOnPeg2 extends CommandGroup {
	...
	public static final double DISTANCE_BACK_TO_CLEAR_BOILER_IN_INCHES = -14.3;
	...
	public AutonPlaceGearOnPeg2() {
		...
		addSequential(
			new ChassisMoveDistance(RobotMap.Component.chassis, AutonPlaceGearOnPeg2.DISTANCE_BACK_TO_CLEAR_BOILER_IN_INCHES,
