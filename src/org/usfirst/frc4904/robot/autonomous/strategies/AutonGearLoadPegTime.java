...
public class AutonGearLoadPegTime extends CommandGroup {
	public static final double TIME_INITIAL_APPROACH_1 = 2.10;
	public static final double TIME_TURN = 0.67;
	...
	public AutonGearLoadPegTime(boolean isBlue) {
		...
		addSequential(new RunFor(new ChassisMove(RobotMap.Component.chassis, new WiggleApproach()),
