...
public class AutonGearLoadPegVision extends CommandGroup {
	...
	public static final double TIME_TURN = 0.75;
	...
	public AutonGearLoadPegVision(boolean isBlue) {
		...
		addSequential(new ChassisConstant(RobotMap.Component.chassis, 0, 0,
		...
		addSequential(new ChassisConstant(RobotMap.Component.chassis, 0,
				AutonGearLoadPegVision.POST_ALIGN_APPROACH_SPEED, 0, AutonGearLoadPegVision.POST_ALIGN_APPROACH_TIME));
		addSequential(new WaitCommand(AutonConfig.PRE_OUTTAKE_DELAY));
		addParallel(new RunFor(new GearioOuttake(), AutonGearLoadPegVision.OUTTAKE_TIME_TOTAL));
		addParallel(new RunAllSequential(
				new WaitCommand(
						AutonGearLoadPegVision.OUTTAKE_TIME_TOTAL - AutonConfig.DEAD_RECKON_TIME_BACK_TO_CLEAR_PEG),
				new ChassisConstant(RobotMap.Component.chassis, 0, AutonConfig.DEAD_RECKON_OUTTAKE_BACKOFF_DRIVE_SPEED,
						0, AutonConfig.DEAD_RECKON_TIME_BACK_TO_CLEAR_PEG)));
	}
}
