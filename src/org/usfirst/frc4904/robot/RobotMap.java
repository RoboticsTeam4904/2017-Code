...
public class RobotMap {
	...
	public RobotMap() {
		...
		// Hopper
		Component.hopper = new Hopper(new DoubleSolenoid(Port.Pneumatics.seeSawLeftDown, Port.Pneumatics.seeSawLeftUp),
			new DoubleSolenoid(Port.Pneumatics.seeSawRightDown, Port.Pneumatics.seeSawRightUp));
